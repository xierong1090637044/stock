...
class Payment extends CI_Controller {
	...
	public function payList(){
		...
		$where  = 'a.isDelete=0 and a.transType=153101 and a.parent='.$this->parent;
	...
	public function add(){
        ...
        $data['created'] = $this->newTime;
			$info = elements(array(
				...
				'description','uid','postData','userName','rpAmount','hxAmount','discount','payment','modifyTime','parent','created'),$data,NULL);
			$this->db->trans_begin();
