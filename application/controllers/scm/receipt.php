...
class Receipt extends CI_Controller {
	...
	public function receiptList() {
		...
		$where  = 'a.isDelete=0 and a.transType=153001 and a.parent='.$this->parent;
	...
	public function add(){
      ...
      $data['created'] = $this->newTime;
			$info = elements(array(
				...
				'billDate','description','uid','userName','rpAmount','arrears','hxAmount','discount','payment','modifyTime','parent','created'),$data,NULL);
			$this->db->trans_begin();
